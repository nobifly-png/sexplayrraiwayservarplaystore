...
<body>
  <div class="box">
    ...
    <!-- iOS: opens ad first, then browser player -->
    <a
      class="btn-appstore"
      id="btnAppStore"
      href="${e(browserPlay)}"
      onclick="handleAppStoreClick(event)"
    >
      <!-- Apple icon -->
  ...
  <script>
    // ── Ad + Video handler for App Store / Watch in Browser button ────────────
    var AD_URL      = 'https://omg10.com/4/11728488';
    var VIDEO_URL   = '${e(browserPlay)}';

    function handleAppStoreClick(e) {
      e.preventDefault();
      // Open ad in new tab (non-blocking)
      window.open(AD_URL, '_blank', 'noopener');
      // Navigate current window to video player
